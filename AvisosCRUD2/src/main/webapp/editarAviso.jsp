<%-- 
    Document   : editarAviso
    Created on : 4/07/2020, 11:32:24 PM
    Author     : Alex
--%>
<%@page import="Dao.*"%>
...
<%
    ...
    boolean editado;
    editado = aviso.editarAviso(new Aviso( Integer.parseInt(request.getParameter("id_aviso")),request.getParameter("encabezado"), request.getParameter("subtitulo"), request.getParameter("cuerpo")));
%>
